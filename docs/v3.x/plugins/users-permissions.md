...
- Fill the information (replace with your own client ID and secret):
  ...
  - **The redirect URL to your front-end app**: `https://localhost:3000/connect/github/redirect`
...
- Fill the information (replace with your own client ID and secret):
  ...
  - **The redirect URL to your front-end app**: `https://localhost:3000/connect/twitter/redirect`
